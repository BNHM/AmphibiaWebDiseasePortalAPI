...
|data/genus_diseaseDetected_Both.json|Bd and Bsal counts grouped by presence-absence and by genus|
|data/genus_diseaseDetected_Bd.json|Bd counts grouped by presence-absence and by genus|
|data/genus_diseaseDetected_Bsal.json|Bsal counts grouped by presence-absence and by genus|
...
|data/scientificName_diseaseDetected_Both.json|Bd and Bsal counts grouped by presence-absence and by scientificName|
|data/scientificName_diseaseDetected_Bd.json|Bd counts grouped by presence-absence and by scientificName|
|data/scientificName_diseaseDetected_Bsal.json|Bsal counts grouped by presence-absence and by scientificName|
...
|data/country_diseaseDetected_Both.json|Bd and Bsal counts grouped by presence-absence and by country|
|data/country_diseaseDetected_Bd.json|Bd counts grouped by presence-absence and by country|
|data/country_diseaseDetected_Bsal.json|Bsal counts grouped by presence-absence and by country|
...
|data/yearCollected_diseaseDetected_Both.json|Bd and Bsal counts grouped by presence-absence and by yearCollected|
|data/yearCollected_diseaseDetected_Bd.json|Bd counts grouped by presence-absence and by yearCollected|
|data/yearCollected_diseaseDetected_Bsal.json|Bsal counts grouped by presence-absence and by yearCollected|
